...
ThemeData buildLightTheme(String? language,
  ...
  var customFont = 'CreatoDisplay';
  final base =
      ThemeData(brightness: Brightness.light, fontFamily: customFont).copyWith(
  ...
  return base.copyWith(
    ...
    textTheme: buildTextTheme(base.textTheme, language, customFont: customFont),
    primaryTextTheme:
        buildTextTheme(base.primaryTextTheme, language, customFont: customFont),
