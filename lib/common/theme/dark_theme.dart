...
ThemeData buildDarkTheme(String? language, [fontFamily, fontHeader]) {
  ...
  return base.copyWith(
    ...
    textTheme:
        buildTextTheme(base.textTheme, language,fontFamily: fontFamily,fontHeader: fontHeader).apply(
      displayColor: kLightBG,
      bodyColor: kLightBG,
    ),
    primaryTextTheme:
        buildTextTheme(base.primaryTextTheme, language,fontFamily: fontFamily,fontHeader:fontHeader)
            .apply(
      displayColor: kLightBG,
      bodyColor: kLightBG,
    ),
