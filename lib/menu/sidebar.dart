              ...
              return ListTile(
                ...
                onTap: () {
                  if (loggedIn) {
                    ...
                    pushNavigation(RouteList.register);
                  }
                },
              );
            }),
      ...
      case 'requestCallback':
        {
          return ListTile(
            ...
            title: Text(
              S.of(context).requestCallback,
              style: textStyle,
            ),
            onTap: () => pushNavigation(RouteList.requestCallback),
          );
        }
      case 'interiorArchitects':
        {
          return ListTile(
            ...
            title: Text(
              S.of(context).interiorArchitects,
              style: textStyle,
            ),
            onTap: () => pushNavigation(RouteList.interiorArchitects),
          );
        }
      case 'franchiseePartner':
        {
          return ListTile(
            leading: Icon(
            ...
            title: Text(
              S.of(context).franchiseePartner,
              style: textStyle,
            ),
            contentPadding: EdgeInsets.only(
                left: 16, right: MediaQuery.of(context).size.width * .1),
            trailing: Container(
              height: 16,
            ...
            onTap: () {
              FirebaseAnalyticsService.frenchiseePartner();
              pushNavigation(RouteList.franchiseePartner);
            },
          );
        }
      default:
