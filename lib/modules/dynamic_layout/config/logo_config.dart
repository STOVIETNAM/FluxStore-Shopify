...
class LogoConfig {
  ...
  LogoConfig.fromJson(dynamic json) {
    ...
    showWishlist = json['showWishlist'] ?? false;
    ...
    notificationIcon = json['notificationIcon'] != null
        ...
        : null;
    wishlistIcon = json['wishlistIcon'] != null
        ? MenuIcon.fromJson(json['wishlistIcon'])
        : null;
  }
