...
class S {
  ...
  String get couponCodeRemovedMessage {
    return Intl.message(
      'Coupon code removed successfully',
      name: 'couponCodeRemovedMessage',
      desc: '',
      args: [],
    );
  }
  ...
  String get shippingReturnPolicy {
    return Intl.message(
      'Shipping & Return Policy',
  ...
  String get interiorArchitects {
    return Intl.message(
      'Interiors & Architects',
      name: 'interiorArchitects',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Franchisee Partner`
  String get franchiseePartner {
    return Intl.message(
      'Franchisee Partner',
      name: 'franchiseePartner',
      desc: '',
      args: [],
    );
  }
  ...
  /// `QUESTIONS?\nWE ARE\nHERE\nTO HELP`
  String get questionWeHereToHelp {
    return Intl.message(
      'QUESTIONS?\nWE ARE\nHERE\nTO HELP',
      name: 'questionWeHereToHelp',
      desc: '',
      args: [],
    );
  }
  ...
  String get warrantyAndInstallation {
    return Intl.message(
      'Warranty & Installation',
      name: 'warrantyAndInstallation',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Customer Redressal`
  String get customerRedressal {
    return Intl.message(
      'Customer Redressal',
      name: 'customerRedressal',
      desc: '',
      args: [],
    );
  }
  ...
  String get enterYourFirstNameHint {
    return Intl.message(
      'Please enter your first name.',
      name: 'enterYourFirstNameHint',
      desc: '',
      args: [],
    );
  }
  ...
  String get enterYourLastNameHint {
    return Intl.message(
      'Please enter your last name.',
      name: 'enterYourLastNameHint',
      desc: '',
      args: [],
    );
  }
  ...
  String get enterYourContactNumberHint {
    return Intl.message(
      'Please enter your contact number.',
      name: 'enterYourContactNumberHint',
      desc: '',
      args: [],
    );
  }
  ...
  String get typeOfQueryHint {
    return Intl.message(
      'Write something you want to know...',
      name: 'typeOfQueryHint',
      desc: '',
      args: [],
    );
  }
  ...
  String get typeOfQueryValidator {
    return Intl.message(
      'Please enter the type of query.',
      name: 'typeOfQueryValidator',
      desc: '',
      args: [],
    );
  }
  ...
  String get querySubmittedSuccessfully {
    return Intl.message(
      '\'Your query was submitted successfully!\'',
      name: 'querySubmittedSuccessfully',
      desc: '',
      args: [],
    );
  }
  ...
  String get weWillSendOTPToPhoneNumber {
    return Intl.message(
      'We will send One Time Password\non this phone number',
      name: 'weWillSendOTPToPhoneNumber',
      desc: '',
      args: [],
    );
  }
  ...
  String get weSentYouSmsCode {
    return Intl.message(
      'We sent you an SMS code',
      name: 'weSentYouSmsCode',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Have any other coupon code`
  String get haveAnyOtherCode {
    return Intl.message(
      'Have any other coupon code',
      name: 'haveAnyOtherCode',
      desc: '',
      args: [],
    );
  }
