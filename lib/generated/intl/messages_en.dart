...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Your available points: ${point}";

  static String m1(state) => "Bluetooth Adapter is ${state}";

  static String m2(day) => "${day} days ago";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Ends in ${timeLeft}";

  static String m5(message) => "Error: ${message}";

  static String m6(time) => "Expiring in ${time}";
  ...
  static String m10(size) => "Maximum file size: ${size} MB";

  static String m11(minute) => "${minute} minutes ago";

  static String m12(month) => "${month} months ago";

  static String m13(itemCount) => "${itemCount} items";

  static String m14(price) => "Options total: ${price}";

  static String m15(total) => "Qty: ${total}";

  static String m16(percent) => "Sale ${percent}%";

  static String m17(second) => "${second} seconds ago";

  static String m18(totalCartQuantity) =>
      "Shopping cart, ${totalCartQuantity} items";

  static String m19(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m20(total) => "${total} products";

  static String m21(date) => "Valid til ${date}";

  static String m22(message) => "Warning: ${message}";

  static String m23(default_currency) =>
      "The currently selected currency is not available for the Wallet feature, please change it to ${default_currency}";

  static String m24(length) => "We found ${length} products";

  static String m25(week) => "Week ${week}";

  static String m26(year) => "${year} years ago";

  static String m27(total) => "You have assigned to order #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "bestCoupon": MessageLookupByLibrary.simpleMessage("Best Coupon"),
        "billingAddress":
        ...
        "couponCodeRemovedMessage": MessageLookupByLibrary.simpleMessage(
        ...
        "customerRedressal":
            MessageLookupByLibrary.simpleMessage("Customer Redressal"),
        ...
        "enterYourContactNumberHint": MessageLookupByLibrary.simpleMessage(
        ...
        "enterYourFirstNameHint": MessageLookupByLibrary.simpleMessage(
            "Please enter your first name."),
        "enterYourLastName":
            MessageLookupByLibrary.simpleMessage("Enter your last name"),
        "enterYourLastNameHint": MessageLookupByLibrary.simpleMessage(
        ...
        "errorPhoneFormat": MessageLookupByLibrary.simpleMessage(
        ...
        "franchiseePartner":
            MessageLookupByLibrary.simpleMessage("Franchisee Partner"),
        ...
        "haveAnyOtherCode":
            MessageLookupByLibrary.simpleMessage("Have any other coupon code"),
        ...
        "interiorArchitects":
            MessageLookupByLibrary.simpleMessage("Interiors & Architects"),
        "invalidPhoneNumber":
        ...
        "moreOffers": MessageLookupByLibrary.simpleMessage("More Offers"),
        ...
        "onNumber": MessageLookupByLibrary.simpleMessage("On number: "),
        ...
        "outOfStockMsg": MessageLookupByLibrary.simpleMessage(
        ...
        "qtyTotal": m15,
        "querySubmittedSuccessfully": MessageLookupByLibrary.simpleMessage(
            "\'Your query was submitted successfully!\'"),
        "questionWeHereToHelp": MessageLookupByLibrary.simpleMessage(
            "QUESTIONS?\nWE ARE\nHERE\nTO HELP"),
        ...
        "requestCallback":
            MessageLookupByLibrary.simpleMessage("Request Callback"),
        "requestForCallback":
            MessageLookupByLibrary.simpleMessage("Request For Call Back"),
        ...
        "returnsAndRefunds":
            MessageLookupByLibrary.simpleMessage("Returns & Refunds"),
        ...
        "shippingReturnPolicy":
            MessageLookupByLibrary.simpleMessage("Shipping & Return Policy"),
        ...
        "typeOfQueries":
            MessageLookupByLibrary.simpleMessage("Type of Queries"),
        "typeOfQuery": MessageLookupByLibrary.simpleMessage("Type of Query"),
        "typeOfQueryHint": MessageLookupByLibrary.simpleMessage(
            "Write something you want to know..."),
        "typeOfQueryValidator": MessageLookupByLibrary.simpleMessage(
            "Please enter the type of query."),
        "typeYourMessage":
        ...
        "warning": m22,
        "warningCurrencyMessageForWallet": m23,
        "warrantyAndInstallation":
            MessageLookupByLibrary.simpleMessage("Warranty & Installation"),
        "weFoundBlogs":
            MessageLookupByLibrary.simpleMessage("We Found Blog(s)"),
        "weFoundProducts": m24,
        "weSentYouSmsCode":
            MessageLookupByLibrary.simpleMessage("We sent you an SMS code"),
        "weWillSendOTPToPhoneNumber": MessageLookupByLibrary.simpleMessage(
